...
console.log(`Transversing array using for loop`);
...
console.log(` access only even index value`);
for (let index = 0; index < arrayOfNumbers.length; index++) {
  if (index % 2 == 0) {
    const element = arrayOfNumbers[index];
    console.log(element);
...
console.log(`======== push() methods=========`);// add element in end
let arrayOfNumber = [4, 5, 6, 8, 9, 1];
console.log(arrayOfNumber);
arrayOfNumber.push(3);
arrayOfNumber.push(11, 12, 33);
console.log(arrayOfNumber);

console.log(`======== unshift() methods=========`); // add element in start
...
console.log(typeof joinResult); //typeof array

console.log(`======== concat() ==========`); //Muliple array Concatination
var arrayOfNum = [4, 5, 6, 8, 9, 33, 66];
